    ...
    settingcol.insert_many(
        [
            {"name": "prefix", "value": "./", "Description": "Sets the command prefix"},
            {
                "name": "admin_roles",
                "value": admin_roles,
                "Description": "A user needs a role in this list to run commands (assuming they don't have discord Administrator perms)",
            },
            {
                "name": "muted_role",
                "value": muted_role,
                "Description": "A user gets this role when they are muted",
            },
            {
                "name": "log_channel_id",
                "value": channel_id,
                "Description": "The default log channel. Unless an action item has a channel set, the bot will log those action items to this channel.",
            },
        ]
    )
